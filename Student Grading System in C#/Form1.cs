...
namespace Univesity_Grade_Calculator
{
    public partial class Form1 : Form
    {
        ...
        {
            if(tb_attendance.Text=="" || tb_Practical.Text == "" || tb_Mid.Text=="" ||tb_quiz1.Text=="" ||tb_quiz2.Text=="" || tb_quiz3.Text=="" || tb_quiz4.Text=="")
            {
                MessageBox.Show("Marking fields should not be left empty.");
            }
            else { 
            int inatt, finalatt, mid, practical, total, percentage, quizsum = 0;
            ...
            lb_mid.Visible = true;
            practical = int.Parse(tb_Practical.Text);
            lb_Practical.Text = practical.ToString() + "/150";
            lb_Practical.Visible = true;
            ...
            total = finalatt + mid + quizsum + practical;
